 ...
 */JNIEXPORT jint JNICALL Java_gwj_dev_ffmpeg_glplayer_VideoSurface_setSurface(
	...
	jclass localVideoSurfaceClass = env->FindClass(
			"gwj/dev/ffmpeg/glplayer/VideoSurface");
	...
	const char *vPath = env->GetStringUTFChars(path, NULL);

	pthread_create(&thread_1, NULL, open_media, (void*)vPath);

	return 0;
}

/*
 * Class:     gwj.dev.ffmpeg_VideoSurface
 * Method:    onPause
 * Signature: ()I
